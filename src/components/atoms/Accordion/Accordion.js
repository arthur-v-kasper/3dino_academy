...
const Root = styled.div`
  ...
  ${props => props.open && css` // adiciona css se item do accordin está aberto.
    margin: 16px 0;
  `}
...
const Head = styled.div`
  ...
  & h6 {
    margin: 0;
    flex: 1 // dessa forma o elemento ocupa o espaço todos, empurrando o icone para o final, mas detalhes na aula 138
  }
