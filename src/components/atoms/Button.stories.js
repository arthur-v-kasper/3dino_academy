...
const ButtonWrapper = (props) => (
  <div>
    ...
    <Toolbar>
      ...
      <Button as="a" href="#" color="primary" {...props} {...events}>Primary</Button>
      <Button as="a" href="#" color="danger" {...props} {...events}>Danger</Button>
    </Toolbar>
    <p>Disabled</p>
    <Toolbar>
      <Button disabled {...props} {...events}>Default</Button>
      <Button disabled color="primary" {...props} {...events}>Primary</Button>
      <Button disabled color="danger" {...props} {...events}>Danger</Button>
    </Toolbar>
  </div>
)
